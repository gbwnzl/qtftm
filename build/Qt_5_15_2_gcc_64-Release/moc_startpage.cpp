...
QT_MOC_LITERAL(1, 10, 12), // "typeSelected"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 16), // "QtFTM::BatchType"
QT_MOC_LITERAL(4, 41, 4) // "type"

    },
    "StartPage\0typeSelected\0\0QtFTM::BatchType\0"
    "type"
};
...
void StartPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->typeSelected((*reinterpret_cast< QtFTM::BatchType(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (StartPage::*)(QtFTM::BatchType );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StartPage::typeSelected)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void StartPage::typeSelected(QtFTM::BatchType _t1)
{
